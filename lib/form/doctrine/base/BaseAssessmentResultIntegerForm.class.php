...
/**
 * AssessmentResultInteger form base class.
 *
 * @method AssessmentResultInteger getObject() Returns the current form's model object
 *
 * @package    ruckus_dev
 * @subpackage form
 ...
 */
abstract class BaseAssessmentResultIntegerForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('assessment_result_integer[%s]');
  ...
  {
    return 'AssessmentResultInteger';
  }
