...
/**
 * AssessmentResultVarchar form base class.
 *
 * @method AssessmentResultVarchar getObject() Returns the current form's model object
 *
 * @package    ruckus_dev
 * @subpackage form
 ...
 */
abstract class BaseAssessmentResultVarcharForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('assessment_result_varchar[%s]');
  ...
  {
    return 'AssessmentResultVarchar';
  }
