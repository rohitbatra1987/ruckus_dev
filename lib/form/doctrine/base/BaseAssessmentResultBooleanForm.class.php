...
/**
 * AssessmentResultBoolean form base class.
 *
 * @method AssessmentResultBoolean getObject() Returns the current form's model object
 *
 * @package    ruckus_dev
 * @subpackage form
 ...
 */
abstract class BaseAssessmentResultBooleanForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('assessment_result_boolean[%s]');
  ...
  {
    return 'AssessmentResultBoolean';
  }
