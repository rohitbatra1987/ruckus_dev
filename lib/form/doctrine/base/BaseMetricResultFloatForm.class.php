...
/**
 * MetricResultFloat form base class.
 *
 * @method MetricResultFloat getObject() Returns the current form's model object
 *
 * @package    ruckus_dev
 * @subpackage form
 ...
 */
abstract class BaseMetricResultFloatForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('metric_result_float[%s]');
