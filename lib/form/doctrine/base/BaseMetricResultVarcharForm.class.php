...
/**
 * MetricResultVarchar form base class.
 *
 * @method MetricResultVarchar getObject() Returns the current form's model object
 *
 * @package    ruckus_dev
 * @subpackage form
 ...
 */
abstract class BaseMetricResultVarcharForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('metric_result_varchar[%s]');
