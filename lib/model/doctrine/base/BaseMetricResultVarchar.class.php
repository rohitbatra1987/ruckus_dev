...
Doctrine_Manager::getInstance()->bindComponent('MetricResultVarchar', 'doctrine');

/**
 * BaseMetricResultVarchar
 * 
 ...
 * @method MetricResultVarchar setMetricResultId()    Sets the current record's "metric_result_id" value
 * @method MetricResultVarchar setMetricId()          Sets the current record's "metric_id" value
 * @method MetricResultVarchar setBookId()            Sets the current record's "book_id" value
 * @method MetricResultVarchar setStudentId()         Sets the current record's "student_id" value
 * @method MetricResultVarchar setResultData()        Sets the current record's "result_data" value
 * @method MetricResultVarchar setAutoId()            Sets the current record's "auto_id" value
 * @method MetricResultVarchar setDeviceId()          Sets the current record's "device_id" value
 * @method MetricResultVarchar setDeviceSessionId()   Sets the current record's "device_session_id" value
 * @method MetricResultVarchar setCreatedAt()         Sets the current record's "created_at" value
 * @method MetricResultVarchar setUpdatedAt()         Sets the current record's "updated_at" value
 * @method MetricResultVarchar setBook()              Sets the current record's "Book" value
 * @method MetricResultVarchar setMetricParameters()  Sets the current record's "MetricParameters" value
 * @method MetricResultVarchar setStudents()          Sets the current record's "Students" value
 * 
 * @package    ruckus_dev
 * @subpackage model
 ...
 */
abstract class BaseMetricResultVarchar extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('metric_result_varchar');
