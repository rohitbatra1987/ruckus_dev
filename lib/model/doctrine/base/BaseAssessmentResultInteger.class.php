...
Doctrine_Manager::getInstance()->bindComponent('AssessmentResultInteger', 'doctrine');

/**
 * BaseAssessmentResultInteger
 * 
 ...
 * @method AssessmentResultInteger setAssmtResultId()      Sets the current record's "assmt_result_id" value
 * @method AssessmentResultInteger setActivityId()         Sets the current record's "activity_id" value
 * @method AssessmentResultInteger setStudentId()          Sets the current record's "student_id" value
 * @method AssessmentResultInteger setAssessmentId()       Sets the current record's "assessment_id" value
 * @method AssessmentResultInteger setResultData()         Sets the current record's "result_data" value
 * @method AssessmentResultInteger setAutoId()             Sets the current record's "auto_id" value
 * @method AssessmentResultInteger setDeviceId()           Sets the current record's "device_id" value
 * @method AssessmentResultInteger setDeviceSessionId()    Sets the current record's "device_session_id" value
 * @method AssessmentResultInteger setCreatedAt()          Sets the current record's "created_at" value
 * @method AssessmentResultInteger setUpdatedAt()          Sets the current record's "updated_at" value
 * @method AssessmentResultInteger setActivities()         Sets the current record's "Activities" value
 * @method AssessmentResultInteger setActivityParameters() Sets the current record's "ActivityParameters" value
 * @method AssessmentResultInteger setStudents()           Sets the current record's "Students" value
 * 
 * @package    ruckus_dev
 * @subpackage model
 ...
 */
abstract class BaseAssessmentResultInteger extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('assessment_result_integer');
