...
Doctrine_Manager::getInstance()->bindComponent('MetricResultInteger', 'doctrine');

/**
 * BaseMetricResultInteger
 * 
 ...
 * @method MetricResultInteger setMetricResultId()    Sets the current record's "metric_result_id" value
 * @method MetricResultInteger setMetricId()          Sets the current record's "metric_id" value
 * @method MetricResultInteger setBookId()            Sets the current record's "book_id" value
 * @method MetricResultInteger setStudentId()         Sets the current record's "student_id" value
 * @method MetricResultInteger setResultData()        Sets the current record's "result_data" value
 * @method MetricResultInteger setAutoId()            Sets the current record's "auto_id" value
 * @method MetricResultInteger setDeviceId()          Sets the current record's "device_id" value
 * @method MetricResultInteger setDeviceSessionId()   Sets the current record's "device_session_id" value
 * @method MetricResultInteger setCreatedAt()         Sets the current record's "created_at" value
 * @method MetricResultInteger setUpdatedAt()         Sets the current record's "updated_at" value
 * @method MetricResultInteger setBook()              Sets the current record's "Book" value
 * @method MetricResultInteger setMetricParameters()  Sets the current record's "MetricParameters" value
 * @method MetricResultInteger setStudents()          Sets the current record's "Students" value
 * 
 * @package    ruckus_dev
 * @subpackage model
 ...
 */
abstract class BaseMetricResultInteger extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('metric_result_integer');
